  ...
  const handleDeletePage = (pageNumber: number) => {
    ...
    pdfDispatch({
      ...
      payload: {
        ...
        pages: updatedPages,
        currentPage:
          pageNumber > updatedPages.length
            ? updatedPages.length
            : pageNumber === currentDocument.currentPage && pageNumber > 1
              ? pageNumber - 1
            ...
            >
              ...
              <div className="p-2">
                <div className="flex items-center justify-between">
                  <span className={`text-xs font-medium ${isCurrentPage ? "text-adobe-blue" : "text-gray-700"}`}>
                    {pageNumber}
                  </span>
