        ...
        <Card className="p-4">
          <div className="flex items-center space-x-3">
            ...
            <div>
              ...
              <p className="text-2xl font-semibold text-gray-900">{jobs.filter((j) => j.isActive).length}</p>
            </div>
          </div>
        </Card>
        ...
        <Card className="p-4">
          <div className="flex items-center space-x-3">
            ...
            <div>
              ...
              <p className="text-2xl font-semibold text-gray-900">{jobs.reduce((sum, j) => sum + j.runCount, 0)}</p>
            </div>
          </div>
        </Card>
                ...
                <div className="space-y-4">
                  ...
                  {job.status === "running" && (
                    <div className="space-y-2">
                      ...
                      {job.estimatedTimeRemaining && (
                        <p className="text-xs text-gray-500">{formatDuration(job.estimatedTimeRemaining)} remaining</p>
                      )}
                    </div>
                  )}
                  ...
                  <div className="space-y-2">
                    ...
                    <div className="flex items-center justify-between text-sm">
                      ...
                      <div className="flex items-center space-x-1">
                        {destinationConfig && <destinationConfig.icon className="w-3 h-3 text-gray-500" />}
                  ...
                  <div className="space-y-2">
                    <div className="flex items-center justify-between text-sm">
                      ...
                      <span className="font-medium">{job.lastRun ? job.lastRun.toLocaleDateString() : "Never"}</span>
                    </div>
                  ...
                  <div className="flex flex-wrap gap-1">
                    ...
                    {job.tags.length > 3 && (
                      <Badge className="bg-gray-100 text-gray-600 text-xs">+{job.tags.length - 3}</Badge>
                    )}
                  </div>
                  ...
                  <div className="flex-1 min-w-0">
                    <div className="flex items-center justify-between mb-2">
                      ...
                      <div className="flex items-center space-x-4 text-sm text-gray-500">
                        ...
                        <span>
                          {job.runCount > 0 ? Math.round((job.successCount / job.runCount) * 100) : 0}% success
                        </span>
      ...
      <div className="bg-white rounded-lg shadow-xl max-w-7xl w-full mx-4 max-h-[90vh] overflow-hidden">
        ...
        <div className="flex items-center justify-between p-6 border-b border-gray-200">
          <div className="flex items-center space-x-3">
            ...
            <Badge className="bg-blue-100 text-blue-800">{jobs.length} jobs</Badge>
          </div>
