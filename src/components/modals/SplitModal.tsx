...
import { XMarkIcon, DocumentIcon, PlusIcon, ScissorsIcon, EyeIcon } from "@heroicons/react/24/outline";
...
export default function SplitModal() {
  ...
  const updateSplitRange = (id: string, field: keyof SplitRange, value: string | number) => {
    setSplitRanges((prev) => prev.map((range) => (range.id === id ? { ...range, [field]: value } : range)));
  };
            ...
            <div className="mt-6">
              ...
              {splitMode === "pages" && (
                <div className="space-y-4">
                  <div>
                    <label className="block text-sm font-medium text-gray-700 mb-2">Pages per split</label>
                    <input
                      type="number"
                      min="1"
                      max={totalPages}
                ...
                <div className="space-y-4">
                  <div>
                    ...
                    <input
                      ...
                      className="w-full px-3 py-2 border border-gray-300 rounded-lg focus:ring-2 focus:ring-adobe-blue focus:border-transparent"
                    />
                    <p className="text-xs text-gray-500 mt-1">Use commas to separate pages and hyphens for ranges</p>
                  </div>
                </div>
              )}
