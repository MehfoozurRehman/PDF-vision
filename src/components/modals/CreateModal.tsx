        ...
        <div className="flex-1 overflow-y-auto p-6 space-y-6">
          ...
          <div>
            ...
            <div className="grid grid-cols-2 md:grid-cols-4 gap-3">
              {[
                { method: 'files', label: 'From Files', desc: 'Convert documents & images' },
                { method: 'scan', label: 'Scan to PDF', desc: 'Scan physical documents' },
                { method: 'web', label: 'Web to PDF', desc: 'Convert web pages' },
                { method: 'blank', label: 'Blank Document', desc: 'Create empty PDF' },
            ...
            <div className="space-y-4">
              ...
              <div className="bg-blue-50 border border-blue-200 rounded-lg p-4">
                <p className="text-sm text-blue-800">
                  <strong>Note:</strong> This is a simulation. In a real implementation, this would connect to scanner hardware or camera.
                </p>
              </div>
            </div>
          )}
          ...
          {createOptions.method === 'web' && (
            <div className="space-y-4">
              ...
              <div className="bg-blue-50 border border-blue-200 rounded-lg p-4">
                <p className="text-sm text-blue-800">
                  <strong>Note:</strong> This is a simulation. In a real implementation, this would capture the actual web page content.
                </p>
              </div>
            </div>
          )}
