...
export const ExportModal: React.FC<ExportModalProps> = ({
  ...
  const groupedFormats = EXPORT_FORMATS.reduce(
    (acc, format) => {
      ...
      <div className="p-6">
        ...
        <div className="flex items-center justify-between mb-6">
          <div>
            ...
            <p className="text-sm text-neutral-600 mt-1">Export "{documentName}" to various formats</p>
          </div>
          ...
          <div>
            ...
            <div className="space-y-4">
              ...
              <div>
                ...
                <div className="p-2 bg-neutral-50 rounded border text-sm text-neutral-600">{getFileName()}</div>
              </div>

              {/* Quality Settings */}
              {selectedFormatData?.category === "image" && (
                <div>
                  <label className="block text-sm font-medium text-neutral-700 mb-2">Quality</label>
              ...
              {selectedFormatData?.supportsPages && (
                <div>
                  <label className="block text-sm font-medium text-neutral-700 mb-2">Page Range</label>
                  <div className="space-y-2">
              ...
              <div>
                ...
                {showAdvanced && (
                  <div className="mt-3 space-y-3 p-3 bg-neutral-50 rounded">
                    ...
                    <div>
                      <label className="block text-xs text-neutral-600 mb-1">Password Protection (optional)</label>
                      <input
                        type="password"
                    ...
                    <div>
                      <label className="block text-xs text-neutral-600 mb-1">Watermark Text (optional)</label>
                      <input
                        type="text"
