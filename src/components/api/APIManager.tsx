      ...
      {viewMode === 'grid' ? (
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-6">
          {sortedEndpoints.map((endpoint) => {
            ...
            return (
              <Card key={endpoint.id} className="p-4 hover:shadow-lg transition-shadow cursor-pointer"
                    onClick={() => {
                  ...
                  <div className="flex items-start justify-between">
                    ...
                    >
                      <HeartIcon className={cn(
                        'w-4 h-4',
                        endpoint.isFavorite ? 'text-red-500 fill-current' : 'text-gray-400'
                      )} />
                    </button>
                  </div>
        ...
        <div className="space-y-3">
          {sortedEndpoints.map((endpoint) => {
            ...
            return (
              <Card key={endpoint.id} className="p-4 hover:shadow-md transition-shadow cursor-pointer"
                    onClick={() => {
                      setSelectedEndpoint(endpoint)
                      setShowEndpointModal(true)
                    }}>
