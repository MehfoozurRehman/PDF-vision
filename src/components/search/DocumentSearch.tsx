...
export default function DocumentSearch({
        ...
        <div className="space-y-4">
          ...
          <div className="flex items-center justify-between">
            ...
            >
              ...
              <ChevronDownIcon
                className={cn("w-4 h-4 transition-transform", showAdvancedOptions ? "rotate-180" : "")}
              />
            </button>
            ...
            {suggestions.slice(0, 6).map((suggestion) => (
              ...
              >
                ...
                <div className="flex-1 min-w-0">
                  ...
                  <p className="text-sm text-gray-600">{suggestion.frequency} searches</p>
                </div>
              </button>
            ))}
          </div>
  ...
  const renderResultsTab = () => (
    <div className="space-y-6">
      ...
      <div className="space-y-4">
        {results
          .filter((result) => !typeFilter || result.type === typeFilter)
          .map((result) => {
              ...
              >
                <div className="space-y-3">
                  ...
                  <div className="bg-gray-50 rounded-lg p-3">
                    <p className="text-sm text-gray-900">{highlightText(result.snippet, result.highlights)}</p>

                    {result.context.before && <p className="text-xs text-gray-500 mt-2">...{result.context.before}</p>}

                    {result.context.after && <p className="text-xs text-gray-500">{result.context.after}...</p>}
                  </div>
      ...
      <div className="bg-white rounded-lg shadow-xl max-w-7xl w-full mx-4 max-h-[90vh] overflow-hidden">
        ...
        <div className="flex items-center justify-between p-6 border-b border-gray-200">
          <div className="flex items-center space-x-3">
            ...
            <Badge className="bg-blue-100 text-blue-800">{results.length} results</Badge>
          </div>
