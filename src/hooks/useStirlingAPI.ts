...
export function useStirlingAPI(): UseStirlingAPIReturn {
  ...
  const executeOperation = useCallback(
    async <T>(operation: () => Promise<T>, successMessage?: string, errorMessage?: string): Promise<T | null> => {
  ...
  const getSystemInfo = useCallback(async () => {
    return executeOperation(() => stirlingClient.getSystemInfo(), undefined, "Failed to get system information");
  }, [executeOperation]);
  ...
  const mergePDFs = useCallback(
    async (files: File[], options?: MergeOptions): Promise<Blob | null> => {
      return executeOperation(
  ...
  const splitPDF = useCallback(
    async (file: File, options: SplitOptions): Promise<Blob | null> => {
      return executeOperation(
  ...
  const compressPDF = useCallback(
    async (file: File, options: CompressOptions): Promise<Blob | null> => {
      return executeOperation(
  ...
  const addPassword = useCallback(
    async (file: File, options: SecurityOptions): Promise<Blob | null> => {
      return executeOperation(
  ...
  const removePassword = useCallback(
    async (file: File, password: string): Promise<Blob | null> => {
      return executeOperation(
  ...
  const addWatermark = useCallback(
    async (file: File, options: WatermarkOptions): Promise<Blob | null> => {
      return executeOperation(
  ...
  const convertPDFToImages = useCallback(
    async (file: File, options: ConversionOptions): Promise<Blob | null> => {
      return executeOperation(
  ...
  const convertImagesToPDF = useCallback(
  ...
  const convertPDFToHTML = useCallback(
    async (file: File): Promise<Blob | null> => {
      return executeOperation(
  ...
  const performOCR = useCallback(
    async (file: File, options: OCROptions): Promise<Blob | null> => {
      return executeOperation(
  ...
  const rotatePDF = useCallback(
    async (file: File, options: RotateOptions): Promise<Blob | null> => {
      return executeOperation(
  ...
  const extractPages = useCallback(
    async (file: File, options: ExtractOptions): Promise<Blob | null> => {
      return executeOperation(
  ...
  const removePages = useCallback(
    async (file: File, pageNumbers: number[]): Promise<Blob | null> => {
      return executeOperation(
  ...
  const addStamp = useCallback(
    async (file: File, options: StampOptions): Promise<Blob | null> => {
      return executeOperation(
